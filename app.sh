...
#  Docker Engine + Buildx 0.30.1 + Compose 2.40.3, системные пакеты и настройки
#
#  Запуск:            sudo bash install_prereqs_ol9.sh
#  С параметрами:     sudo DOCKER_PROXY=http://IP:PORT bash install_prereqs_ol9.sh
# =============================================================================
set -euo pipefail
...
# ----------------------------- 6. sysctl -------------------------------------
log "6. vm.max_map_count для Elasticsearch"
